...
//FIX THIS so that it returns the actual voltage
        if(resistorValue == 0 && currentValue == 0 ){
            return(voltageValue); 
        }
        else{
            return (resistorValue*currentValue);
        }
    }
...
//FIX THIS
        if(voltageValue != 0 && resistorValue != 0){
...
//is between 5 and -5, otherwise print an error message.
    ...
    //FIX THIS
        ...
        if(voltageValue == 0){
            return(currentValue*currentValue*resistorValue); 
        }
        else{
            return((voltageValue*voltageValue)/resistorValue); 
        }
    }
